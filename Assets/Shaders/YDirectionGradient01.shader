...
/////// Diffuse:
                ...
                float3 diffuseColor = ((pow((1.0 - dot(viewDirection,i.normalDir)),_sharpness)*_node_4018.rgb)+lerp(_node_25.rgb,_node_4807.rgb,(i.posWorld.g*_node_5699)));
